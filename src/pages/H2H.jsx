...
export const H2HPage = () => {
  ...
  const handleSearch = async () => {
    ...
    try {
      const [blitzRaw, bulletRaw] = await Promise.all([
        loadRawMatchesByMode("blitz", { filters: { usernamePair: [first, second] } }),
        loadRawMatchesByMode("bullet", { filters: { usernamePair: [first, second] } }),
      ]);
  ...
  const renderPlayerPanel = (name, side, modeScores) => (
    <section className={`h2hPlayerPanel ${side === "right" ? "right" : "left"}`}>
      ...
      <div className="h2hModeCard">
        <h3>blitz</h3>
        <p className="h2hModeScoreValue">{modeScores.blitz}</p>
      </div>
      <div className="h2hModeCard">
        <h3>bullet</h3>
        <p className="h2hModeScoreValue">{modeScores.bullet}</p>
      </div>
    </section>
  );
        ...
        {hasSearched && loadedPlayer1 && loadedPlayer2 ? (
          <>
            ...
            <div className="h2hSplitLayout">
              ...
              {renderPlayerPanel(loadedPlayer1, "left", {
                blitz: blitzScore.playerA,
                bullet: bulletScore.playerA,
              })}
              {renderPlayerPanel(loadedPlayer2, "right", {
