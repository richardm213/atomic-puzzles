...
export const puzzleMotifs: PuzzleMotif[] = [
  ...
  },
  {
    ...
    description:
      "A tactic in which a knight enters the opponent's position.",
  },
  {
    tag: "bishop_invasion",
    name: "Bishop invasion",
    description:
      "A tactic in which a bishop enters the opponent's position.",
  },
  {
    tag: "rook_invasion",
    name: "Rook invasion",
    description:
      "A tactic in which a rook enters the opponent's position.",
  },
  {
  ...
  },
  {
    ...
    name: "Rook mate",
    description:
      "A rook gives mate or creates an unavoidable mating threat along a rank or file.",
  },
  {
    tag: "king_blockade",
    name: "King blockade",
    description:
      "The king blocks an opposing pawn from advancing, usually in the endgame.",
  },
  {
    tag: "square",
    name: "Square",
  ...
  },
  {
    ...
    name: "Stuck pawn",
    description:
      "A pawn with no useful move becomes a weakness, an obstruction, or a target.",
  },
  {
    tag: "stuck_piece",
    name: "Stuck piece",
