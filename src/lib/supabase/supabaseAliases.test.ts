...
import { buildAliasIdentityRowsFromAliases2Rows } from "./supabaseAliases";

describe("buildAliasIdentityRowsFromAliases2Rows", () => {
  it("groups aliases2 account rows by canonical user", () => {
    const rows = buildAliasIdentityRowsFromAliases2Rows([
      {
        alias: "Grevozin",
        username: "wolfram_ep",
        banned: false,
