...
with metadata(legacy_event, event_name, event_date, players) as (
  values
    ('ACL S2: Lesha vs Maracker', 'ACL S2', '2026-02-21', array['Lesha','Maracker']),
    ('ACL S2: RabbieR vs Quasabianth', 'ACL S2', '2026-03-08', array['RabbieR','Quasabianth']),
    ('ACL S2: Studieb vs Quasabianth', 'ACL S2', '2026-03-26', array['Studieb','Quasabianth']),
    ...
    ('Atomic960 Swiss ''26: Qed vs Rkr', 'Atomic960 Swiss', '2026-02-28', array['queeneatingdragon','rkrounit']),
    ('Blitz Practice Apr ''26: Rechesster vs Opabinia', '3+2 match', '2026-03-19', array['Rechesster','Opabinia']),
    ('Blitz Practice Apr ''26: Rechesster vs Paper-skies', '3+2 match', '2026-04-21', array['Rechesster','Paper-skies']),
    ('Blitz Practice Sep ''26: Wolfram vs Max', '3+2 match', '2026-09-20', array['Wolfram','Max']),
    ('Blitz Practice Sep ''26: Wolfram vs Rechesster', '3+2 match', '2026-09-10', array['Wolfram','Rechesster']),
    ('AWC 2018: Tipau vs Onubense', 'AWC', '2018-11-27', array['Tipau','Onubense']),
    ('AWC 2021: Wolfram vs Astavakra', 'AWC', '2021-10-16', array['Wolfram','Astavakra']),
    ('AWC 2023: Jsf vs Lesha', 'AWC', '2023-11-04', array['Jsf','Lesha']),
    ('AWC 2025: Max vs Sircachetes', 'AWC', '2025-09-28', array['Max','Sircachetes']),
    ('AWC 2025: Sircachetes vs Blackjack', 'AWC', '2025-09-21', array['Sircachetes','Blackjack']),
    ('AWC 2025: Wolfram vs Randoom', 'AWC', '2025-10-08', array['Wolfram','Randoom']),
    ('Wolfrandom 1st Time: Wolfram vs Rkr', 'Wolfarena', '', array['Wolfram','Rkr']),
    ...
    ('Wolfrandom Sep ''26: Rabbie vs Quasa', 'Wolfrandom', '2026-09-25', array['Rabbie','Quasa']),
    ('Wolfarena 2026: ReChesster vs Wolfram_EP', 'Wolfarena', '2026-08-07', array['ReChesster','Wolfram_EP']),
    ('Wolfarena 2026: Wolfram - Quasabianth', 'Wolfarena', '2026-07-23', array['Wolfram','Quasabianth']),
    ('Wolfarena 2026: BeAfraidOfYourDesire - RabbieR', 'Wolfarena', '2026-08-16', array['BeAfraidOfYourDesire','RabbieR']),
