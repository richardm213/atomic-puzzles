...
with metadata(legacy_event, event_name, event_date, players) as (
  values
    ...
    ('Blitz Practice Apr ''26: Rechesster vs Opabinia', 'Blitz 8-game match', '2026-04', array['Rechesster','Opabinia']),
    ('Blitz Practice Apr ''26: Rechesster vs Paper-skies', 'Blitz match', '2026-04', array['Rechesster','Paper-skies']),
    ('Blitz Practice Sep ''26: Wolfram vs Max', 'Blitz 6-game match', '2026-09', array['Wolfram','Max']),
    ('Blitz Practice Sep ''26: Wolfram vs Rechesster', 'Blitz 10-game match', '2026-09', array['Wolfram','Rechesster']),
